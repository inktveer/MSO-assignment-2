...
Within the structure of the sequences, an \textit{Factory Method} pattern is used to more easily produce large numbers of sequences. This minimises the amount of code duplication in the \ffcode{Init} class, where the hard coded programs are written out.\\~\\
